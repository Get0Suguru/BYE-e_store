...
const Navbar = ({ onSelectCategory, onSearch }) => {
  ...
  useEffect(() => {
    ...
    document.body.style.backgroundColor = theme === "dark-theme" ? "rgb(31, 31, 31)" : "rgb(255, 255, 255)";
  }, [theme]);
      ...
      <header>
        <nav className="navbar navbar-expand-lg fixed-top">
          <div className="container-fluid">
            <a className="navbar-brand p-2" href="https://www.caranddriver.com/news/a64322842/yangwang-u7-ev-phev-china-details/">
              BYE
            </a>
            <button
